  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
      ...
      >
        ...
        {/* Feedback Messages */}
        {error && (
          <div className="mt-4 bg-red-100 text-red-800 text-center p-2 rounded-lg text-sm">
            {error}
          </div>
        )}
        {success && (
          <div className="mt-4 bg-green-100 text-green-800 text-center p-2 rounded-lg text-sm">
            {success}
          </div>
        )}
      </form>

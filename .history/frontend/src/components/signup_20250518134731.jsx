...
// Removed useForm as it's not being used in the provided snippet
...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => { // Made the function async to use await with axios
    e.preventDefault();
    ...
    const userInfo = {
      ...
      email: email,
      password: password,
      // confirmPassword: confirmPassword, // Usually confirmPassword is not sent to the backend
    };
    ...
    try {
      ...
      if (res.data.success) {
        ...
        // Removed the alert() here for a better user experience
      ...
      console.error("There was an error during signup:", err);
      if (err.response) {

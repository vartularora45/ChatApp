...
const SignUp = () => {
 ...
 const userInfo = {
      ...
      email: email,
      password: password,
      confirmPassword: confirmPassword, // You might not need to send confirmPassword to backend
    };
    ...
    try {
      ...
      if (res.data.success) {
        setUser(res.data.user); // Assuming backend sends user data back
        setError(null);

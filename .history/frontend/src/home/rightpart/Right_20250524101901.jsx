...
const Right = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-screen  text-white">
...
console.log(user)
  return (
    <div className="flex flex-1 justify-center items-center h-full bg-black">

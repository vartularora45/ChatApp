...
const User = ({ user }) => {
  ...
  return (
    <div
      className={`flex items-center justify-between px-6 py-4 hover:bg-gray-400 ${
    ...
    >
      ...
      <div className="relative w-12 h-12">
        ...
        />
        {isOnline && (
          <span className="absolute top-0 right-0 w-4 h-4 bg-green-800 border-2 border-white rounded-full"></span>
        )}
      </div>

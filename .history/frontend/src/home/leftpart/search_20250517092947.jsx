...
const search = () => {
  return (
    <div className="flex-col flex items-center justify-center h-16 shadow-md mt-12">
      <div class="flex flex-col- items-center border border-gray-300 rounded-full px-4 py-2 w-78 transition-all duration-300 focus-within:shadow-md focus-within:border-blue-500">

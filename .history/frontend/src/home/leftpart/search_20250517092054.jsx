...
const search = () => {
  return (
    <div className="flex-col flex items-center justify-center h-16 shadow-md mt-8">
      <div class="flex items-center border border-gray-300 rounded-full px-4 py-2 w-7 transition-all duration-300 focus-within:shadow-md focus-within:border-blue-500">

  ...
  return (
    <div
      className="flex items-center justify-center h-16 shadow-md mt-5">
       <div class="flex items-center border border-gray-300 rounded-full px-4 py-2 w- transition-all duration-300 focus-within:shadow-md focus-within:border-blue-500">

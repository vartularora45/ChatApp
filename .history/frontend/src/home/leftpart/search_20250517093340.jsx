...
const search = () => {
  ...
  <button
    class="p-3 rounded-full bg-white text-blue-600 text-xl shadow-lg transform transition-all duration-500 hover:scale-125 hover:rotate-12 hover:shadow-blue-400 animate-pulse"
  >
